...
bool testComprimir()
{
    ...
    v.push_back( Par( 5, 6 ) );
    v.push_back( Par( 0, 3 ) );
    v.push_back( Par( 6, 10 ) );
    v.push_back( Par( 6, 7 ) );
    v.push_back( Par( 15, 16 ) );
    v.push_back( Par( 17, 20 ) );
    v.push_back( Par( 4, 17 ) );

    comprimir( v );
    paso = paso && v.size() == 1 && v.front() == Par( 0, 20 );
...
bool testComplemento()
{
    ...
    resultado.push_back( Par( 9, 10 ) );

    paso = paso && v == resultado;
